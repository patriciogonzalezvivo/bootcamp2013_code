...
void draw(){
  ...
  myGreen = map(mouseY, 0, height, 0, 255); // takes the mouseY position (vertical mouse position) and maps it to a number between 0 and 255, which will set how much green our color has
